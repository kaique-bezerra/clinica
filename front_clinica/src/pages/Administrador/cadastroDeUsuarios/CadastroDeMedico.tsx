          ...
          <form className="patient-form" onSubmit={handleSubmit}>
            ...
            <fieldset className="form-group-box">
              ...
              <div className="form-row3">
                <div className="input-group">
                  <label>CRM</label>
                  <input type="text" name="crm" value={formData.crm} onChange={handleChange} required placeholder="000000" />
                </div>
                <div className="input-group">
                  <label>Especialidade</label>
                  <input type="text" name="especialidade" value={formData.especialidade} onChange={handleChange} required placeholder="Ex: Cardiologista" />
                </div>
              </div>
            </fieldset>
